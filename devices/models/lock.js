...
class Lock {
    constructor(id, latitude, longitude, batteryLevel, status = Lock_Status.FREE, alarm = Lock_Alarm.OFF , magneticSensor = Lock_MagneticSensor.OFF) {
        this.id = id;
    ...
    toggleMagneticSensor() {
        this.magneticSensor = this.magneticSensor === Lock_MagneticSensor.ON ? Lock_MagneticSensor.OFF : Lock_MagneticSensor.ON;
    }
