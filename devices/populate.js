...
const locks = [
  ...
  new Lock('lock-2', 45.4645, 9.191, 65, Lock_Status.FREE, Lock_Alarm.OFF, Lock_MagneticSensor.ON),
  new Lock('lock-3', 45.465, 9.192, 40, Lock_Status.FREE, Lock_Alarm.ON, Lock_MagneticSensor.OFF),
  new Lock('lock-4', 45.466, 9.193, 10, Lock_Status.OUT_OF_ORDER),
];

const gateways = [
  new Gateway('gateway-1', 'Gateway Centrale', ['lock-1', 'lock-2'], 45.4642, 9.19, Gateway_Status.CONNECTED),
  new Gateway('gateway-2', 'Gateway Nord', ['lock-3'], 45.467, 9.195, Gateway_Status.NOT_CONNECTED),
  new Gateway('gateway-3', 'Gateway Sud', ['lock-4'], 45.463, 9.188, Gateway_Status.UNKNOWN),
];
